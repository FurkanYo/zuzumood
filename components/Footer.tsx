        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-24">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[10px] text-muted uppercase tracking-[0.2em]">
              ...
              <li><Link to="/terms" className="hover:text-black transition-colors underline-offset-4 hover:underline">Terms of Service</Link></li>
              <li><Link to="/privacy" className="hover:text-black transition-colors underline-offset-4 hover:underline">Privacy Policy</Link></li>
            </ul>
          </div>
        </div>
